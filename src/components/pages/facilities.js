...
import image52 from "../../libimg.jpg"
import image53 from "../../Internet-marketing.jpg"
import image54 from "../../hostel.jpg"
import image55 from "../../buses.jpg"
        ...
        return (
            <div>
                ...
                <h3 className="alileft">College Library</h3>
                    ...
                    <img className="pic1" src={image52}/>
                    ...
                    <img className="pic1" src={image53}/>
                ...
                <h3 className="int">Hostels</h3>
                    <div className="line1"> </div>   
                    <img className="pic2" src={image54}/>   
                    ...
                    <div className="line1"> </div>  
                    <img className="pic2" src={image55}/>    
